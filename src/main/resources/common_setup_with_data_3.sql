...
-- Dumping structure for таблиця final_project_db.flight
...
-- Dumping data for table final_project_db.flight: ~0 rows (приблизно)
DELETE FROM `flight`;
...
INSERT INTO `flight` (`id`, `flight_number`, `plane_id`, `departure_id`, `arrival_id`, `departure_date`, `arrival_date`, `price_casual`, `price_business`) VALUES
	...
	(3, 'AirbusFlight', 8, 1, 2, '2016-11-25 12:36:00', '2016-11-26 12:36:00', NULL, NULL),
	(4, 'Airbus5000Flight', 8, 1, 2, '2016-11-29 12:36:00', '2016-11-30 12:36:00', NULL, NULL);
/*!40000 ALTER TABLE `flight` ENABLE KEYS */;


-- Dumping structure for таблиця final_project_db.location
...
-- Dumping data for table final_project_db.location: ~2 rows (приблизно)
...
-- Dumping structure for таблиця final_project_db.person
...
-- Dumping data for table final_project_db.person: ~3 rows (приблизно)
DELETE FROM `person`;
...
INSERT INTO `person` (`id`, `first_name`, `last_name`, `age`, `passport`, `email`) VALUES
	...
	(4, 'Petro', 'Petrov', 35, 'AA123456', 'petrov@mail.ru'),
	(5, 'Petro', 'Petrov', 35, 'AA123456', 'petrov@mail.ru'),
	(6, 'Petro', 'Petrov', 35, 'AA123456', 'petrov@mail.ru');
/*!40000 ALTER TABLE `person` ENABLE KEYS */;


-- Dumping structure for таблиця final_project_db.plane
...
-- Dumping data for table final_project_db.plane: ~6 rows (приблизно)
DELETE FROM `plane`;
...
-- Dumping structure for таблиця final_project_db.seat
...
-- Dumping data for table final_project_db.seat: ~124 rows (приблизно)
DELETE FROM `seat`;
...
-- Dumping structure for таблиця final_project_db.ticket
...
-- Dumping data for table final_project_db.ticket: ~0 rows (приблизно)
DELETE FROM `ticket`;
